...
class _AdminMachineBoxState extends State<AdminMachineBox> {
                ...
                children: [
                  ...
                  AnimatedButton(
                    onPressed: () async {
                      ...
                      final dataToUpdate =
                          updatedMachine
                              .where((item) => isSelected.contains(item.machineId))
                              .toList();
                      ...
                      showSnackBarSuccess(localContext, 'Đã cập nhật thành công');
                    },
                    label: "Lưu Thay Đổi",
                    icon: Symbols.save,
  ...
  Widget _buildTableSection() {
    return FutureBuilder<List<AdminMachineBoxModel>>(
            ...
            rows: List<DataRow>.generate(data.length, (index) {
              ...
              return DataRow(
                cells: [
                  ...
                  DataCell(styleCellAdmin(text: machine.machineName.toString(), onChanged: null)),
                ],
              );
            }),
          ),
