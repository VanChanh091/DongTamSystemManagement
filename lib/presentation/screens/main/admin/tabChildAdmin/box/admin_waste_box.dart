...
class _AdminWasteBoxState extends State<AdminWasteBox> {
                ...
                children: [
                  ...
                  AnimatedButton(
                    onPressed: () async {
                      ...
                      final dataToUpdate =
                          updatedWasteNorms
                              .where((item) => isSelected.contains(item.wasteBoxId))
                              .toList();
                                                  ...
                                                  ElevatedButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      for (int id in isSelected) {
                                                        await AdminService().deleteWasteBox(
                                                          wasteNormId: id,
                                                        );
                                                      }
  ...
  Widget _buildTableSection() {
    return FutureBuilder<List<AdminWasteBoxModel>>(
            ...
            rows: List<DataRow>.generate(data.length, (index) {
              ...
              return DataRow(
                cells: [
                  ...
                  DataCell(styleCellAdmin(text: wasteNorm.machineName.toString(), onChanged: null)),
                ],
              );
            }),
          ),
