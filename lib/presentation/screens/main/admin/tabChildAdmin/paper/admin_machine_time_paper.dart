                    ...
                    onPressed: () async {
                      ...
                      final dataToUpdate =
                          machineDatasource!.machinePapers
                              .where((item) => selectedPaperIds.contains(item.machineId))
                              .toList();
            ...
            StackedHeaderRow(
              cells: [
                StackedHeaderCell(
                  ...
                  child: Obx(
                    () => formatColumn(label: 'Tốc Độ Máy', themeController: themeController),
                  ),
                ),
                StackedHeaderCell(
                  columnNames: ["changeDiffSize", "changeSameSize"],
                  child: Obx(
                    () => formatColumn(label: 'Thời Gian Đổi', themeController: themeController),
                  ),
                ),
              ],
            ),
