                ...
                children: [
                  ...
                  AnimatedButton(
                    onPressed: () async {
                      ...
                      final dataToUpdate =
                          updatedWasteNorms
                              .where((item) => isSelected.contains(item.wasteNormId))
                              .toList();
                      ...
                      for (final item in dataToUpdate) {
                        ...
                        await AdminService().updateWastePaper(
                          ...
                          wasteNormUpdate: {
                            ...
                            "lossInSheetingAndSlitting": item.lossInSheetingAndSlitting,
                                                  ...
                                                  ElevatedButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      for (int id in isSelected) {
                                                        await AdminService().deleteWastePaper(
                                                          wasteNormId: id,
                                                        );
                                                      }
                ...
                cells: [
                  ...
                  DataCell(
                    styleCellAdmin(
                      ...
                      onChanged: (value) {
                        setState(() {
                          wasteNorm.lossInSheetingAndSlitting = double.tryParse(value) ?? 0;
                        });
                      },
                    ),
                  ),
