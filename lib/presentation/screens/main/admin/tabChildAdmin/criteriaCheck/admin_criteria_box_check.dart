...
class _AdminCriteriaBoxCheckState extends State<AdminCriteriaBoxCheck> {
                  ...
                  onPressed: () async {
                    ...
                    final rowsToUpdate =
                        tableData
                            .where(
                              (e) =>
                                  e.criteriaBoxId != null && isSelected.contains(e.criteriaBoxId),
                            )
                            .toList();
  ...
  Widget _buildTableSection() {
    return FutureBuilder<List<AdminInspectionBoxModel>>(
                  ...
                  child: Checkbox(
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        if (selectedAll) {
                          isSelected =
                              tableData.map((e) => e.criteriaBoxId).whereType<int>().toList();
                        } else {
                          isSelected.clear();
                        }
                      });
