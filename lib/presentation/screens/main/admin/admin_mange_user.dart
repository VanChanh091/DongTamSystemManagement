                        ...
                        selectedUserIds.isNotEmpty
                            ? () async {
                              if (selectedUserIds.length > 1) {
                                showSnackBarError(context, "Chỉ được cập nhật mỗi lần 1 user");
                                return;
                              }
                              ...
                              final selectedUser = users.firstWhere(
                                ...
                                orElse: () {
                                  AppLogger.e('Selected user not found after loading list.');
                                  return users.first;
                                },
                              );
                    ...
                    rows: List<DataRow>.generate(data.length, (index) {
                      ...
                      return DataRow(
                        cells: [
                          ...
                          DataCell(styleCell(label: UserAdminModel.formatRole(role: user.role))),
                          DataCell(
                            styleCell(
                              label: UserAdminModel.formatDepartment(department: user.department),
                            ),
                          ),
                          DataCell(
                            styleCell(label: UserAdminModel.formatPermissions(user.permissions)),
                          ),
                        ],
                      );
                    }),
