...
class _AdminVehicleState extends State<AdminVehicle> {
              ...
              children: [
                ...
                AnimatedButton(
                  onPressed: () async {
                    ...
                    final rowsToUpdate =
                        tableData
                            .where((e) => e.vehicleId != null && isSelected.contains(e.vehicleId))
                            .toList();
                                                ...
                                                ElevatedButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    for (int id in isSelected) {
                                                      await AdminService().deleteVehicle(
                                                        vehicleId: id,
                                                      );
                                                    }
  ...
  Widget _buildTableSection() {
    return FutureBuilder<List<AdminVehicleModel>>(
                  ...
                  child: Checkbox(
                    ...
                    onChanged: (value) {
                      setState(() {
                        selectedAll = value!;
                        if (selectedAll) {
                          isSelected = tableData.map((e) => e.vehicleId).whereType<int>().toList();
                        } else {
                          isSelected.clear();
                        }
                      });
                ...
                cells: [
                  DataCell(
                    Theme(
                      ...
                      child: Checkbox(
                        value: vehicle.vehicleId != null && isSelected.contains(vehicle.vehicleId),
                        onChanged:
                            vehicle.vehicleId == null
                                ? null
                                : (val) {
