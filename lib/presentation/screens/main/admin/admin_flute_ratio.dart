...
class _AdminFluteRatioState extends State<AdminFluteRatio> {
                    ...
                    onPressed: () async {
                      ...
                      final rowsToUpdate =
                          tableData
                              .where(
                                (e) =>
                                    e.fluteRatioId != null && isSelected.contains(e.fluteRatioId),
                              )
                              .toList();

                      // check tick checkbox
                      final hasUpdateRow = tableData.any((e) => e.fluteRatioId != null);
                      ...
                      for (final e in rowsToAdd) {
                        await AdminService().addFluteRatio(
                          fluteRatioData: {"fluteName": e.fluteName, "ratio": e.ratio},
                        );
                      }
                      ...
                      for (final e in rowsToUpdate) {
                        await AdminService().updateFluteRatio(
                          ...
                          fluteRatioUpdate: {"fluteName": e.fluteName, "ratio": e.ratio},
                        );
                      }
                                                  ...
                                                  ElevatedButton(
                                                    ...
                                                    onPressed: () async {
                                                      ...
                                                      for (int id in isSelected) {
                                                        await AdminService().deleteFluteRatio(
                                                          fluteRatioId: id,
                                                        );
                                                      }
  ...
  Widget _buildTableSection() {
    return FutureBuilder<List<AdminFluteRatioModel>>(
                  ...
                  child: Checkbox(
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        if (selectedAll) {
                          isSelected =
                              tableData.map((e) => e.fluteRatioId).whereType<int>().toList();
                        } else {
                          isSelected.clear();
                        }
                      });
