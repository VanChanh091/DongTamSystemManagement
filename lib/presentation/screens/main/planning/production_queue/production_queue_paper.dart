              ...
              children: [
                ...
                Expanded(
                  ...
                  child: LeftButtonSearch(
                    ...
                    types: const ['Tất cả', 'Mã Đơn Hàng', 'Tên Khách Hàng', 'Khổ Cấp Giấy'],
                    onTypeChanged: (value) {
                      setState(() {
                        searchType = value;
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            rowMoveButtons(
                              ...
                              onMoveUp: () {
                                _cachedDatasource!.moveRowUp(selectedPlanningIds);
                              },
                              onMoveDown: () {
                                _cachedDatasource!.moveRowDown(selectedPlanningIds);
                              },
                            ),
                              ...
                              onSelected: (value) async {
                                if (value == 'change') {
                                  if (selectedPlanningIds.isEmpty) {
                                    showSnackBarError(context, "Chưa chọn kế hoạch cần chuyển máy");
                                    return;
                                  }
                                  ...
                                  await handlePlanningAction(
                                    ...
                                    message: "Bạn có chắc muốn dừng các kế hoạch đã chọn không?",
                                  ...
                                  await handlePlanningAction(
                                    ...
                                    message: "Bạn có chắc muốn hủy kế hoạch đơn này không?",
                                  ...
                                  if (selectedPlanningIds.isEmpty) {
                                    showSnackBarError(context, "Chưa chọn kế hoạch cần ghi chú");
                                    return;
                                  ...
                                  await showInputQtyDialog(
                                    ...
                                    onConfirm: () async {
                                      try {
                                        final success = await PlanningService().addNoteToPlanning(
                                          planningId: int.parse(selectedPlanningIds.first),
                                        ...
                                        if (success) {
                                          if (context.mounted) {
                                            showSnackBarSuccess(context, "Thêm ghi chú thành công");
                                          }
                                        ...
                                        if (context.mounted) {
                                          showSnackBarError(context, "Thêm ghi chú thất bại");
                                        }
                                        return false;
                                      }
                                    },
  ...
  Widget _buildTableSection() {
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        if (_cachedPapers == null || _cachedPapers != data || _cachedShowGroup != showGroup) {
          _cachedPapers = data;
