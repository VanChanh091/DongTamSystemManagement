...
class _OrderDialogState extends State<OrderDialog> {
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: Column(
                                    children: [
                                      checkboxForBox("Cắt khe", catKheChecked),
                                      checkboxForBox("Bế", beChecked),
                                      checkboxForBox(
                                        "Đóng ghim",
                                        dongGhimChecked,
                                      ),
  ...
  Widget checkboxForBox(String label, bool checked) {
