...
class DialogExportOrders extends StatefulWidget {
  const DialogExportOrders({super.key});

  @override
  State<DialogExportOrders> createState() => _DialogExportOrdersState();
}

class _DialogExportOrdersState extends State<DialogExportOrders> {
  ...
  void submit() async {
    try {
      ...
      file = await SyntheticService().exportExcelOrders(
            ...
            child: Column(
              ...
              children: [
                ...
                RadioListTile<String>(
                  title: const Text("Ngày Nhận Đơn", style: TextStyle(fontSize: 16)),
                  value: "dayReceive",
                ),
